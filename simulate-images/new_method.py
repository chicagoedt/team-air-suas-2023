...
test2.line((list((tar_poly.envelope).exterior.coords[1]) + list((tar_poly.envelope).exterior.coords[2])), fill="Purple", width=3)
test2.line((list((tar_poly.envelope).exterior.coords[2]) + list((tar_poly.envelope).exterior.coords[3])), fill="Purple", width=3)
test2.line((list((tar_poly.envelope).exterior.coords[3]) + list((tar_poly.envelope).exterior.coords[0])), fill="Purple", width=3)
